...
Route::resource('dash', HomeController::class)->middleware('auth');
...
Route::get('/descargar_pdf', [ArticuloController::class,'downloadPDF']);
Route::get('/descargar_pdfP', [ProveedorController::class,'downloadPDF']);
Route::get('/export', [ArticuloController::class,'export']);
